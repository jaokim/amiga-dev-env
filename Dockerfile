...
RUN ln /usr/bin/ppc-amigaos-addr2line /usr/bin/addr2line && ln /usr/bin/ppc-amigaos-ar /usr/bin/ar && ln /usr/bin/ppc-amigaos-as /usr/bin/as && ln /usr/bin/ppc-amigaos-c++ /usr/bin/c++ && ln /usr/bin/ppc-amigaos-c++filt /usr/bin/c++filt && ln /usr/bin/ppc-amigaos-cpp /usr/bin/cpp && ln /usr/bin/ppc-amigaos-elfedit /usr/bin/elfedit && ln /usr/bin/ppc-amigaos-g++ /usr/bin/g++ && ln /usr/bin/ppc-amigaos-gcc /usr/bin/gcc && ln /usr/bin/ppc-amigaos-gcc-ar /usr/bin/gcc-ar && ln /usr/bin/ppc-amigaos-gcc-nm /usr/bin/gcc-nm && ln /usr/bin/ppc-amigaos-gcc-ranlib /usr/bin/gcc-ranlib && ln /usr/bin/ppc-amigaos-gcov /usr/bin/gcov && ln /usr/bin/ppc-amigaos-gcov-dump /usr/bin/gcov-dump && ln /usr/bin/ppc-amigaos-gcov-tool /usr/bin/gcov-tool && ln /usr/bin/ppc-amigaos-gprof /usr/bin/gprof && ln /usr/bin/ppc-amigaos-ld /usr/bin/ld && ln /usr/bin/ppc-amigaos-ld.bfd /usr/bin/ld.bfd && ln /usr/bin/ppc-amigaos-nm /usr/bin/nm && ln /usr/bin/ppc-amigaos-objcopy /usr/bin/objcopy && ln /usr/bin/ppc-amigaos-objdump /usr/bin/objdump && ln /usr/bin/ppc-amigaos-ranlib /usr/bin/ranlib && ln /usr/bin/ppc-amigaos-readelf /usr/bin/readelf && ln /usr/bin/ppc-amigaos-size /usr/bin/size && ln /usr/bin/ppc-amigaos-strings /usr/bin/strings && ln /usr/bin/ppc-amigaos-strip /usr/bin/strip
